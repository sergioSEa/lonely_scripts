...
#Parts:
#1. Ancestral State reconstruction: Requires dataset of diapsida and otol trimmed tree
#2. Transition count: Requires state likelihoods produced at 1
#3. Study of codon frequency by bird order. Requires a table of birds labeled with the corresponding order and the presence/Absence of the insertion and Jarvis et al. tree for plotting
#4. Entrophy. Requires entrophy metrics
#5. Codon analysis: Requieres codon frequencies.
...
#Look for different ancestral positions
...
#Add taxonomical information for records that do not have based
...
#Make figure based on Jarvis tree
